...
import { Button, ButtonAdd, Container } from './styles';

export interface INavbarProps {
  active: 'diet' | 'library';
}

export const Navbar: React.FC<INavbarProps> = ({ active }: INavbarProps) => {
  return (
    <Container>
      <Link href="/diet">
        <Button active={active === 'diet'}>
      ...
      <Link href="/library">
        <ButtonAdd active={active === 'library'}>
