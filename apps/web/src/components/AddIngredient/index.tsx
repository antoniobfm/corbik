...
export const AddIngredient: React.FC<AddIngredientProps> = ({ setIsModalActive }: AddIngredientProps) => {

  return (
    <Container>
      <Close onClick={() => setIsModalActive(false)}>
        <span>Close</span>
      ...
      <Library>
        <div className="list">
          ...
          <FoodListing brand='Mother Nature' name='Fettuccine Alfredo' macros={{ carbs: 5, prots: 2, fats: 3 }} calories={440} key='2' />
          <FoodListing brand='Mother Nature' name='Pizza' macros={{ carbs: 5, prots: 2, fats: 3 }} calories={440} key='2' />
          <FoodListing brand='Mother Nature' name='Lasagna' macros={{ carbs: 5, prots: 2, fats: 3 }} calories={440} key='2' />
        </div>
        <SearchBar />
      </Library>
    </Container>
